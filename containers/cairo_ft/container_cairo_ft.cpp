...
std::shared_ptr<litehtml::element>	container_cairo_ft::create_element(const litehtml::tchar_t *tag_name,
...
void container_cairo_ft::link(const std::shared_ptr<litehtml::document> &ptr, const litehtml::element::ptr& el)
{
}
