...
litehtml::media_query::ptr litehtml::media_query::create_from_string(const tstring& str, const lhmemory::shared_ptr<document>& doc)
{
	media_query::ptr query = lhmemory::make_shared<media_query>();
...
litehtml::media_query_list::ptr litehtml::media_query_list::create_from_string(const tstring& str, const lhmemory::shared_ptr<document>& doc)
{
	media_query_list::ptr list = lhmemory::make_shared<media_query_list>();
